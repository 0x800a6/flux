const currentDate = new Date().toLocaleString('en-US', { hour: '2-digit', minute: '2-digit', second: '2-digit' });
...
class TerminalDemo {
    constructor() {
        ...
        this.commands = [
            {
                prompt: `[${currentTime}] puppy@cage in ~/source/github.com/chocoOnEstrogen/flux (master)`,
                command: 'ls -la',
